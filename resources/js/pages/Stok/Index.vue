        ...
        <table class="min-w-full text-sm">
          ...
          >
            <tr>
              ...
              <th class="px-4 py-3 text-right font-medium text-gray-600 dark:text-gray-300" :class="user?.level == null ? 'hidden' : ''">Pemasukan</th>
              <th class="px-4 py-3 text-right font-medium text-gray-600 dark:text-gray-300">Cost</th>
              <th class="px-4 py-3 text-right font-medium text-gray-600 dark:text-gray-300">Qty-</th>
              <th class="px-4 py-3 text-right font-medium text-gray-600 dark:text-gray-300" :class="user?.level == null ? 'hidden' : ''">Pengeluaran</th>
