...
* @see app/Http/Controllers/PenjualanController.php:287
* @route '/penjualan'
*/
...
* @see app/Http/Controllers/PenjualanController.php:29
...
* @see app/Http/Controllers/PenjualanController.php:38
...
const PenjualanController = { exportMethod, index, create, store, print, show, editInfo, destroy, storeItem, updateItem, destroyItem, biayaLain, storePayment, updatePayment, destroyPayment, export: exportMethod }
